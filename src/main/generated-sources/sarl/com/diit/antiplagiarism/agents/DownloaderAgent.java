...
public class DownloaderAgent extends Agent {
  private final String baseDir = "~/APMSDocs";
  
  private void $behaviorUnit$Initialize$0(final Initialize occurrence) {
    Logging _$CAPACITY_USE$IO_SARL_CORE_LOGGING$CALLER = this.$castSkill(Logging.class, (this.$CAPACITY_USE$IO_SARL_CORE_LOGGING == null || this.$CAPACITY_USE$IO_SARL_CORE_LOGGING.get() == null) ? (this.$CAPACITY_USE$IO_SARL_CORE_LOGGING = this.$getSkill(Logging.class)) : this.$CAPACITY_USE$IO_SARL_CORE_LOGGING);
    String _GetIp = DomainHelper.GetIp();
    _$CAPACITY_USE$IO_SARL_CORE_LOGGING$CALLER.info(("Downloader agent started on " + _GetIp));
  }
  
  private void $behaviorUnit$TaskToDo$1(final TaskToDo occurrence) {
    TaskModel task = occurrence.Task;
    try {
      new File(this.baseDir).mkdir();
      final String path = ((this.baseDir + "/") + task.Name);
      InputStream in = new URL(task.Url).openStream();
      Files.copy(in, Paths.get(path), StandardCopyOption.REPLACE_EXISTING);
      task.Path = path;
      DefaultContextInteractions _$CAPACITY_USE$IO_SARL_CORE_DEFAULTCONTEXTINTERACTIONS$CALLER = this.$castSkill(DefaultContextInteractions.class, (this.$CAPACITY_USE$IO_SARL_CORE_DEFAULTCONTEXTINTERACTIONS == null || this.$CAPACITY_USE$IO_SARL_CORE_DEFAULTCONTEXTINTERACTIONS.get() == null) ? (this.$CAPACITY_USE$IO_SARL_CORE_DEFAULTCONTEXTINTERACTIONS = this.$getSkill(DefaultContextInteractions.class)) : this.$CAPACITY_USE$IO_SARL_CORE_DEFAULTCONTEXTINTERACTIONS);
      FileDownloadEvent _fileDownloadEvent = new FileDownloadEvent(task.Url, StateEnum.Success, task.TaskId);
      _$CAPACITY_USE$IO_SARL_CORE_DEFAULTCONTEXTINTERACTIONS$CALLER.emit(_fileDownloadEvent);
    } catch (final Throwable _t) {
      if (_t instanceof Exception) {
        final Exception e = (Exception)_t;
        DefaultContextInteractions _$CAPACITY_USE$IO_SARL_CORE_DEFAULTCONTEXTINTERACTIONS$CALLER_1 = this.$castSkill(DefaultContextInteractions.class, (this.$CAPACITY_USE$IO_SARL_CORE_DEFAULTCONTEXTINTERACTIONS == null || this.$CAPACITY_USE$IO_SARL_CORE_DEFAULTCONTEXTINTERACTIONS.get() == null) ? (this.$CAPACITY_USE$IO_SARL_CORE_DEFAULTCONTEXTINTERACTIONS = this.$getSkill(DefaultContextInteractions.class)) : this.$CAPACITY_USE$IO_SARL_CORE_DEFAULTCONTEXTINTERACTIONS);
        String _string = e.toString();
        FileDownloadEvent _fileDownloadEvent_1 = new FileDownloadEvent(task.Url, StateEnum.Failed, task.TaskId, _string);
        _$CAPACITY_USE$IO_SARL_CORE_DEFAULTCONTEXTINTERACTIONS$CALLER_1.emit(_fileDownloadEvent_1);
      } else {
  ...
  @SyntheticMember
  @PerceptGuardEvaluator
  private void $guardEvaluator$TaskToDo(final TaskToDo occurrence, final Collection<Runnable> ___SARLlocal_runnableCollection) {
    assert occurrence != null;
    assert ___SARLlocal_runnableCollection != null;
    ___SARLlocal_runnableCollection.add(() -> $behaviorUnit$TaskToDo$1(occurrence));
  }
  ...
  public boolean equals(final Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    DownloaderAgent other = (DownloaderAgent) obj;
  ...
  public int hashCode() {
    ...
    final int prime = 31;
    result = prime * result + Objects.hashCode(this.baseDir);
    return result;
  }
  
  @SyntheticMember
  public DownloaderAgent(final UUID parentID, final UUID agentID) {
  ...
  @Inject
  @Deprecated
  public DownloaderAgent(final BuiltinCapacitiesProvider provider, final UUID parentID, final UUID agentID) {
    super(provider, parentID, agentID);
  }
  
  @SyntheticMember
  @Inject
  public DownloaderAgent(final UUID parentID, final UUID agentID, final DynamicSkillProvider skillProvider) {
