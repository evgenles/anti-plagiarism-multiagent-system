...
public class AnalizeManagerAgent extends Agent {
  ...
  @SyntheticMember
  public AnalizeManagerAgent(final UUID parentID, final UUID agentID) {
  ...
  @Inject
  @Deprecated
  public AnalizeManagerAgent(final BuiltinCapacitiesProvider provider, final UUID parentID, final UUID agentID) {
    super(provider, parentID, agentID);
  }
  
  @SyntheticMember
  @Inject
  public AnalizeManagerAgent(final UUID parentID, final UUID agentID, final DynamicSkillProvider skillProvider) {
