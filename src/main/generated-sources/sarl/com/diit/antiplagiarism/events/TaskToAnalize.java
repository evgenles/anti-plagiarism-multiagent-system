...
public class TaskToAnalize extends Event {
  public TaskModel Task;
  
  public TaskToAnalize(final TaskModel task) {
    this.Task = task;
  }
  ...
  /**
   * Returns a String representation of the TaskToAnalize event's attributes only.
   */
  @SyntheticMember
  @Pure
