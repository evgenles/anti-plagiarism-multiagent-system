...
public class TaskToCompare extends Event {
  public TaskModel Task;
  
  public TaskToCompare(final TaskModel task) {
    this.Task = task;
  }
  ...
  /**
   * Returns a String representation of the TaskToCompare event's attributes only.
   */
  @SyntheticMember
  @Pure
